...
const [blackAndWhite, black,, pink] = ['cow', 'horse', 'sheep', 'pig', 'chicken'].map(animal => colors.includes(animal)? colors[colors.indexOf(animal)] : 'blackAndWhite');
...
const { indigo: indg } = colors.reduce((acc, color) => {
  acc[color] = color;
  return acc;
}, {});
